...
/// rows — if no `path` row names it any more. `Db::delete_document` sweeps
/// its vectors itself now; this function no longer has to remember to.
///
...
/// name this document?" the same way, through this one function.
