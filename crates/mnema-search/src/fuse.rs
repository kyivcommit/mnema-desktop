...
///
/// The first two are not fusions at all — they are D106's other two
/// configurations, and they live here because the sweep prints them as rows of
/// one table. Pinned by `a_single_arm_rule_ignores_the_other_arm_entirely`.
...
/// rather than the rule. Pinned by `the_limit_cuts_the_fused_list_not_the_arms`.
